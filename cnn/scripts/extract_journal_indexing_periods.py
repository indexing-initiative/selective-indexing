...
from helper import should_review_coverage_note, save_delimited_data
...
def run(config):
    ...
    FULL_INDEXING_PERIODS_FILEPATH = config['full_indexing_periods_output_file']
    ...
    full_time_periods = _extract_time_periods(serials, 'Full')
    _serialize_time_periods(FULL_INDEXING_PERIODS_FILEPATH, ENCODING, full_time_periods)
...
def  _serialize_time_periods(filepath, encoding, time_periods):
    ...
    for time_period in time_periods:
        ...
        review_coverage_note_text = should_review_coverage_note(coverage_note_text)
    ...
    save_delimited_data(filepath, encoding, '|', output_list)
